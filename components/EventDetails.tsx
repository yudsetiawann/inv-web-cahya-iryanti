          ...
          {events.map((event, i) => {
            ...
            return (
              ...
              >
                ...
                {/* Ikon Premium */}
                <div className="relative w-16 h-16 mb-8 rounded-full bg-[#fefae0]/50 border border-[#6b705c]/10 flex items-center justify-center text-[#6b705c] group-hover:bg-[#6b705c] group-hover:text-[#fefae0] group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
                  <Icon size={28} strokeWidth={1.5} />
                </div>

                {/* Judul Acara */}
                <h3 className="font-script text-4xl md:text-5xl text-[#6b705c] mb-6">
                  {event.title}
                </h3>
                ...
                <div className="space-y-5 flex-1 flex flex-col items-center justify-start w-full">
                  {/* Waktu */}
                  <div className="flex items-center gap-2.5 px-6 py-2 rounded-full bg-[#fefae0]/40 border border-[#6b705c]/10">
                    <Clock size={16} className="text-[#c9a96e]" />
                    <span className="font-sans text-[#6b705c] text-sm tracking-widest font-medium">
                      {event.time}
                    </span>
                  </div>

                  <div className="w-10 h-[1px] bg-[#6b705c]/10 my-2" />
                  ...
                  <div>
                    ...
                    <p className="font-sans text-[#6b705c] text-sm leading-relaxed opacity-80 max-w-[260px]">
                      {event.address}
                    </p>
                  </div>
                </div>
                ...
                <a
                  ...
                  className="mt-10 relative z-10 flex items-center gap-2 font-sans text-xs tracking-[0.2em] uppercase font-medium text-[#fefae0] bg-[#6b705c] px-8 py-3.5 rounded-full hover:bg-[#5a5e4d] hover:shadow-lg active:scale-95 transition-all duration-300"
                >
                  <MapPin size={14} />
                  Lihat Peta
                </a>
